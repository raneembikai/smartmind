...
<body>
  ...
  <script>
    const buttons = {
      spaceShooterBtn: 'spaceShooter.php',
      memoryMatchBtn: 'memory_card_match.php',
      ticTacToeBtn: 'XO.php',
      game2048Btn: '2048.php',
      flappyBirdBtn: 'flappy_bird_game.php',
      sortColorsBtn: 'pattern_sequence_game.php',
      mazeGameBtn: 'maze_game.php',
      patternGameBtn: 'simons_game.php'
    };
