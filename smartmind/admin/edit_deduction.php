...
$query = "SELECT * FROM deduction_questions WHERE id = $id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_query = "UPDATE deduction_questions SET 
    ...
    if (mysqli_query($con, $update_query)) {
        header("Location: manage_deduction.php"); // Redirect after successful update
        exit();
    } else {
        echo "Update failed!";
    }
...
<html>
<head>
    <title>Edit Deduction Question</title>
    <style>
